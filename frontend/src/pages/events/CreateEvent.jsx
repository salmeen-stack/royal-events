        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <input
                type="checkbox"
                id="requiresContribution"
                name="requiresContribution"
                checked={formData.requiresContribution}
                onChange={(e) => setFormData(prev => ({ ...prev, requiresContribution: e.target.checked }))}
                className="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500"
              />
              <label htmlFor="requiresContribution" className="text-sm font-medium text-gray-700">
                Require contribution for invitations
              </label>
            </div>
            <p className="text-xs text-gray-500 ml-7">
              When enabled, invitations will only be sent to guests who have paid their contribution. When disabled, invitations can be sent to all guests regardless of payment status.
            </p>
          </div>

          {formData.requiresContribution && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Input
